...
# Run this once to register the email agent as a Windows startup task.
...
Write-Host "    The email agent will start automatically at every login."
Write-Host ""
