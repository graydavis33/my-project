# Gray — Health Shopping List

A running list of products mentioned as we work through the health plan. Honest reasoning + rough cost on each. Nothing here is hype — if it's not worth it, it's in the "Skip / Scams" section.
...
| Product | What it's for | Priority | Rough cost | Status |
|---|---|---|---|---|
| Creatine monohydrate (plain, unflavored) | Muscle, strength, cognition. Most-studied supplement there is. Don't pay for fancy versions. 5g/day. | NOW | $15–20 (months' supply) | Not bought |
| Whey protein | Protein target / recovery. Any clean brand. Note: nudges insulin needs a little (T1D). | NOW | $25–45 | Not bought |
...
- Free NYC water lead test kit — request via 311 / NYC DEP (costs nothing).

---

## Skip / Scams (you asked me to be straight)
