...
- Beat 9: the five conversations. Beat 10: the mid-doc rehook ("I could've heard all of that and still done nothing—"). THIS is Beat 11 — and it's Day 0 on the tracking calendar.
- Filling the commit cards on camera IS this beat. Pinning them to OPEN closes success-bar loop S2 and arms S3.
- Same filming day, right after: shoot every before-state and every prediction (tracking doc rules — the before-state dies the moment a change ships).
...
> SAI: "Card one. [NAME] said—"
>
> (CUT TO: the 1-on-1 clip — the anecdote, their words)
>
> (back on Sai, writing) "The change: [THE CHANGE — ONE LINE]."
>
> "It counts as shipped when [SHIP ACTION] — by [DATE]."
>
> "And the proof is [NAME]. Two weeks from now I go back and ask — better, or not. And whatever the answer is, it stays in the video."
>
> (pins the card to OPEN)

If one of the three is the feedback system, its reveal flips the template:
...
> SAI: "That's the bet. Three cards, two weeks. Every one of them has to cross this board — shipped, then proven. And not proven by me — proven by the people who put them up here."
>
> (per card, to camera: "[CARD]. What I think happens: [EXPECTATION]. What I'm afraid of: [FEAR]. What failure looks like: [FAILURE].")

Closer line — three options (pick one on the day):

1. "The vault picked the tactic. The team picked the changes. The only thing left that can screw this up is the guy who usually does."
