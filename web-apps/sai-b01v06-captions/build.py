"""Build index.html for the b01v06 captions: one-line, scaled-down caption groups
...
PROPER_NOUNS = {"waddell"}  # names stay capitalized
  ...
  <head>
    ...
    <style>
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      #cap-layer { position: absolute; left: 0; right: 0; top: 1180px; text-align: center; }
