# Executive Assistant / Second Brain — Initialize Prompt

Source: Liam Ottley (liam-workspace-template)
Purpose: Full onboarding prompt to set up Claude Code as a personal executive assistant.
Run once per new project/workspace to scaffold the folder structure and populate context files.
